    ...
    <div className="grid grid-cols-2 gap-[40px] pt-[120px] pb-[50px] px-[50px] w-full min-w-0 max-w-full overflow-hidden">
      ...
      <div className="col-span-1 min-w-0 flex flex-col gap-[40px]">
        <div className="flex flex-row gap-[25px] items-center">
          ...
          <div className="font-cormorant text-primary font-bold text-[50px]">{data.title}</div>
        </div>
        <a
        ...
        <span className="font-cormorant text-[22px] text-browny whitespace-pre-line break-words hyphens-auto max-w-full">
          {data.description}
        </span>
      </div>
    </div>
